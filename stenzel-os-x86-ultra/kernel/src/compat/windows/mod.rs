...
pub fn get_windows_compat_status() -> Vec<FeatureStatus> {
    alloc::vec![
        ...
        FeatureStatus {
            ...
            notes: Some(String::from("Basic import resolution")),
        },
        FeatureStatus {
        ...
        FeatureStatus {
            ...
            level: CompatLevel::Partial,
            notes: Some(String::from("Core NT functions")),
        },
        FeatureStatus {
            name: String::from("KERNEL32"),
            level: CompatLevel::Partial,
            notes: Some(String::from("File, process, memory APIs")),
        },
        FeatureStatus {
            name: String::from("MSVCRT"),
            level: CompatLevel::Stub,
            notes: Some(String::from("C runtime")),
        },
        FeatureStatus {
            name: String::from("USER32"),
            level: CompatLevel::Stub,
            notes: Some(String::from("GUI support planned")),
        },
        FeatureStatus {
            name: String::from("GDI32"),
            level: CompatLevel::Stub,
            notes: Some(String::from("Graphics planned")),
        },
        FeatureStatus {
        ...
        FeatureStatus {
            ...
            level: CompatLevel::Stub,
            notes: Some(String::from("VFS-based emulation")),
        },
        FeatureStatus {
        ...
        FeatureStatus {
            ...
            level: CompatLevel::Stub,
            notes: Some(String::from("Structured Exception Handling")),
        },
    ]
}
...
pub fn init() {
    ...
    crate::kprintln!("wincompat: Windows compatibility layer ready");
}
